                ...
                <Col lg='6' md='6'>
                    <div className="hero__content">
                        ...
                        <div className="mt-4 hero__btn d-flex align-items-center gap-4">
                           <button className="hire_btn"><a href="https://drive.google.com/file/d/1SRHBI1bDmSLTNmhGjgsLCaetBEvGJJU-/view?usp=share_link"  rel="noreferrer" target="_blank">Resume</a></button> 
